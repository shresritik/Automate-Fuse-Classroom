...
waits for 10seconds irresepctive of the complete loading of the webpage.

2. It checks for "Join Class" button in the page for 10 times, if found then it is clicked
